...
| ------------- |:-------------:| -----:| -----:| -----:|
| 6.1.2-1 | The % character of the file header shall occur at byte offset 0 of the file. The first line of a PDF file is a header identifying the version of the PDF specification to which the file conforms.  | callas_234 (but very general!)|  |  | 
