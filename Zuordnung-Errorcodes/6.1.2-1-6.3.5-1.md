...
| 1_6.2.4-3 | If an Image dictionary contains the Interpolate key, its value shall be false.  | callas_158 | PDFA244 |  | 
...
| 1_6.2.7-1 | A conforming file shall not contain any PostScript XObjects.  | callas_101, callas_102, callas_103  | PDFA271 |  | 
| 1_6.2.8-1 | An ExtGState dictionary shall not contain the TR key.  | nicht gefunden | PDFA41 (circa) |  | 
| 1_6.2.8-2 | An ExtGState dictionary shall not contain the TR2 key with a value other than Default.  | nicht gefunden | nicht so detailliert |  | 
| 1_6.2.9-1 | Where a rendering intent is specified, its value shall be one of the four values defined in PDF Reference RelativeColorimetric, AbsoluteColorimetric, Perceptual or Saturation.  | callas_156 | PDFA243, PDFA291 |  | 
| 1_6.2.10-1 | A content stream shall not contain any operators not defined in PDF Reference even if such operators are bracketed by the BX/EX compatibility operators.  | nicht gefunden | PDFA012 und PDFA12, aber viel allgemeiner |  | 
