...
| ------------- |:-------------:| -----:| -----:| -----:|
| 6.2.11.3-4 | For those CMaps that are embedded, the integer value of the WMode entry in the CMap dictionary shall be identical to the WMode value in the embedded CMap stream.  | callas_171 | PDFA3332 | ? | 
